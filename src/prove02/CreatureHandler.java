	...
	*/
	public void updateCreatures() {
		...
		for(Creature c : _creatures) {
				...
				//Process the Sense Neighbors capabilities of creatures that are Aware
				...
				//Process the Move capabilities of creatures that are Movable
				if(c instanceof Movable) {
					handleMove(c);
				}

				//Process the Attack capabilities of creatures that are Aggressors
				...
				//Process the Spawn capabilities of creatures that are Spawners
				if (c instanceof Spawner) {
					Creature spawn = ((Spawner) c).spawnNewCreature();
					if (spawn != null) {
						newCreatures.add(spawn);
					}
				}
				
			}

		//Add spawned creatures to the master creatures list
